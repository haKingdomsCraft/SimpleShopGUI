...
public $Blocks = [
    ...
    "Emerald Block" => [133,0,1500,1398],
    "Diamond Block" => [57,0,10000,50],
    "Glass" => [20,0,500,30],
    "Iron Block" => [42,0,500,30],
    "Gold Block" => [41,0,500,30],
    "Purpur Blocks" => [201,0,500,30],
    "Quartz Block" => [155,0,130,30],
  ...
  public $Food = [
    ...
    "Enchanted Golden Apple" => [466,0,3300,3000]
  ];
  ...
  public $Miscellaneous = [
    ...
    "Totem of Undying" => [450,0,600,500],
  ...
  public function sendMainShop(Player $player){
    $ui = new SimpleForm("§6§lTrex§eCraft §bShopUI§r!","       §aPurchase and Sell items Here!");
